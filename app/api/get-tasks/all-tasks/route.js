...
async function getTasks(token) {
    try {
        ...
        const [rows] = await pool.query('SELECT t.taskId, t.taskDescr, t.taskDeadlines, DATE_FORMAT(t.taskActualClose, "%Y-%m-%dT%TZ") AS taskActualClose, t.taskDateCreate, t.taskGlobalResult, t.taskStatus FROM tasks t ORDER BY t.taskDateCreate DESC');
